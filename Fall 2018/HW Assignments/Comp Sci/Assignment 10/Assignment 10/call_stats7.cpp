...
Description: The program uses a dynamic array to add and remove members of a database. The program does this by the user created ADT class. While using operator and function overloading.
*************************************************************/
#include <iostream>
#include <string>
#include <fstream>
